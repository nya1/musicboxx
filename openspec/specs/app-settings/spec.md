...
The application SHALL provide a **Settings** destination in primary navigation, a dedicated Settings route and page, structured sections for **appearance** and **library data** (including future backup/import), accessible navigation, and offline-capable presentation of local preferences.
