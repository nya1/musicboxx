# apple-music-links Specification

## Purpose

Apple Music track URLs on `music.apple.com`: parsing, public metadata (no OAuth), cover artwork, and opening tracks in Apple Music externally.
